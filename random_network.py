...
def simulate_population(size=10000, N=100, generations=150, initial_cooperator_ratio=0.5, 
    ...
    graph = nx.random_regular_graph(N, size)
...
def __main__():
    ...
    parser.add_argument('--N', type=int, default=100, help='neighbors')
    ...
    for seed in tqdm(seeds, desc='Seeds'):
        ...
        final_population, history_frequency, history_fitness = simulate_population(
            size=args.size, N=args.N, generations=args.gen, initial_cooperator_ratio=args.ratio, 
